...
public class TOLMatrix extends TOLLObject {
    ...
    /**
     * Construye un objeto <code>TOLMatrix</code> con el número especificado de filas y columnas,
     ...
     * @see com.hcarralero.toljava.TOLMatrixException
     */
    public TOLMatrix(int rows, int columns) throws TOLMatrixException {
        if (rows<=0) {
    ...
    /**
     * Construye un objeto <code>TOLMatrix</code>na partie de un arreglo doble (matriz) de números reales.
     *
     ...
     * @see com.hcarralero.toljava.TOLMatrixException
     */
    public TOLMatrix(double values[][]) throws TOLMatrixException {
     ...
     *
     * @return <code>true</code> ya que el objeto corresponde al tipo Matrix de TOL.
     */
    @Override
     ...
     * <code>TOLMatrix</code> y representa una matriz con igual cantidad de filas
    ...
    public boolean equals(Object obj) {
        ...
        final TOLMatrix other = (TOLMatrix) obj;
