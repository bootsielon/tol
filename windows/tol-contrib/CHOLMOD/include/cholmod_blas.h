...
#if defined(_USE_BLAPI_)

#include <gbla/blapi.h>

#define BLAS_DTRSV call_dtrsv
#define BLAS_DGEMV call_dgemv
#define BLAS_DTRSM call_dtrsm
#define BLAS_DGEMM call_dgemm
#define BLAS_DSYRK call_dsyrk
#define BLAS_DGER  call_dger
#define BLAS_DSCAL call_dscal
#define LAPACK_DPOTRF call_dpotrf

#define BLAS_ZTRSV call_ztrsv
#define BLAS_ZGEMV call_zgemv
#define BLAS_ZTRSM call_ztrsm
#define BLAS_ZGEMM call_zgemm
#define BLAS_ZHERK call_zherk
#define BLAS_ZGER  call_zgeru
#define BLAS_ZSCAL call_zscal
#define LAPACK_ZPOTRF call_zpotrf
