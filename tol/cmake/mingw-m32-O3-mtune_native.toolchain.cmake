...
set(CMAKE_CXX_FLAGS_RELEASE   "${CMAKE_CXX_FLAGS_RELEASE} -DNDEBUG -O3 -mtune=native" CACHE STRING "c++ flags in Release" )
set(CMAKE_C_FLAGS_RELEASE     "${CMAKE_C_FLAGS_RELEASE} -DNDEBUG -O3 -mtune=native"   CACHE STRING "c flags in Release" )
