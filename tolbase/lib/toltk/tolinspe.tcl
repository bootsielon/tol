...
#/////////////////////////////////////////////////////////////////////////////
  ...
  if {$grammar eq "Set" || $grammar eq "NameBlock"} {
    ...
    if {$grammar eq "Set"} {
      ...
      #(pgea) se utiliza la informaci�n de instancia
...
#/////////////////////////////////////////////////////////////////////////////
  ...
  ClearHiertables
#(pgea) se quita la l�nea que oculta la columna del �ndice y que
 ...
 # variable w_text       ;# TODO: ????
  ...
  if { [string length $OnSelectItem] } {
    ...
    if { [string length $entry] } {
      ...
      #(pgea) se a�ade la propiedad Reference
...
#(pgea) nueva funci�n para obtener la informaci�n de instancia
...
#(pgea) nueva funci�n para obtener el contenido de la instancia
