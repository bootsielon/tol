...
#/////////////////////////////////////////////////////////////////////////////
  ...
  for  {set gr 0} {$gr<$data(gr,numGraph)} {incr gr} {
    ...
    if {!$holdon} {
      ...
      set opt(gr,$gr,xTicksFont)    [$rini $key xTicksFont   {{Lucida Console} 9}]
      set opt(gr,$gr,yTicksFont)    [$rini $key yTicksFont   {{Lucida Console} 9}]
      ...
      set opt(gr,$gr,x2TicksFont)   [$rini $key x2TicksFont   {{Lucida Console} 9}]
      set opt(gr,$gr,y2TicksFont)   [$rini $key y2TicksFont   {{Lucida Console} 9}]
      ...
      set opt(gr,$gr,linewidth)     [$rini $key linewidth 3]
      ...
      set opt(gr,$gr,legend,Font)     [$rini $key legendFont      {{Lucida Console} 9}]
