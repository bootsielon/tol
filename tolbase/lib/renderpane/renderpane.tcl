...
snit::widgetadaptor renderpane {
    ...
    # The missing image to show when [!image !] could not be resolved
    option -missingimage ""
    ...
    typevariable defaultMissingImage

    # Type constructor: build resources
    typeconstructor {
      set defaultMissingImage [ image create photo -data {
        R0lGODlhIAAgAIAAADNmmQUFBSwAAAAAIAAgAAACYIyPqZvgD6OcztCLn81c7g4C36Vwo8cE2Kml
        B6lSb1VOLBS3iJx3NRoSNWy9zA/oG/JAR6RRuTTtntIZ9WldFYk3YpC5RXWdvOkVZtZis7D1GBeO
        pNVfad1+p+fLrn6qAAA7q
      } ]
    }
    ...
    method InsertImage {arglist} {
        ...
        try {
          ...
          set images [ list $options(-missingimage) ]
        }
    ...
    proc LoadImage {filename {width 0} {height 0}} {
        ...
        } elseif { [ lsearch [ image names ] $filename ] != -1 } {
          # It is a valid tk image
          set img $filename
        } else {
          error "$filename does not reference a valid image"
        }
...
package provide renderpane 2.1.3